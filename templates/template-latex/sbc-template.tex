...
\title{D* uma implementação dinâmica do A*}

\author{Guilherme Cauladal\inst{1}, Pedro Cacique\inst{1} }
...
\begin{resumo} 
	O algoritmo A* é o algorítimo de busca mais utilizado na industria de games e robótica,
