...
\subsection{Implementação e Testes}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=1\textwidth]{propriedades.png}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.5\textwidth]{heuristiccomp.png}
		\caption{Comparação entre as heurísticas Manhattan (a), Diagonal (b) e sem heurística (c).}.
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=1\textwidth]{adaptacao.png}
